...
Implements RBPrjProcessing
	...
	#tag Note, Name = About
		...
		//
		// It does not store data from the project header (where Icons, File Types and Build Settings
