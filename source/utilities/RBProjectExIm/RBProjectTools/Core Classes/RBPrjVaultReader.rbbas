		...
		Private Sub parseAllFiles(processor as RBPrjProcessing)
		  ...
		  for i = 0 to Ubound (filesToParse)
		    ...
		    if f <> nil then
		      ...
		      results.errMsgs.Append "Vault file """+namesToParse(i)+""" can not be found"
		    end
		  next
		  ...
		  for i = 0 to Ubound(me.origVaultFiles)
		    results.warnMsgs.Append "Vault file """+me.origVaultFiles(i).Name+""" is not part of the project"
		  next
