...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Sub ReloadDirectory()
		  ...
		  path = BackgroundFolder.NativePath
		  ...
		  If BackgroundFolder.NativePath <> App.DocsFolder.Child("Backgrounds").NativePath Then
		...
		Sub Paint(g As Graphics, areas() As REALbasic.Rect)
		  ...
		  If ImgNdx <= UBound(ImageFiles) Then
		    ...
		    Else
		      ...
		      If ImageThumbs.HasKey(ImageFiles(ImgNdx).NativePath) Then
		        thumb = ImageThumbs.Value(ImageFiles(ImgNdx).NativePath)
		      End If
		      ...
		      If Not IsNull(thumb) Then
		        ...
		        If Not ImageThumbs.HasKey(ImageFiles(ImgNdx).NativePath) Then
		          ImageThumbs.Value(ImageFiles(ImgNdx).NativePath) = thumb
		        End If
		      Else
